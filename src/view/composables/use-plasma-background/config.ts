...
export const createDefaultConfig = (): PlasmaConfig => ({
  ...
  // Плазменное поле (мобильные)
  mobileFieldSize: 60, // Уменьшенный размер для мобильных
  mobileFieldDetail: 100, // Уменьшенная детализация для мобильных

  fieldSpeed: 0.6, // Общая скорость анимации плазменного поля
  fieldAmplitude: 5.0, // Амплитуда волн плазменного поля

  // Основные частицы (десктоп)
  particleCount: 12000, // Количество основных частиц

  // Основные частицы (мобильные)
  mobileParticleCount: 6000, // Уменьшенное количество частиц для мобильных
  ...
  // Светящиеся частицы (глоу) (десктоп)
  glowParticleCount: 1000, // Количество светящихся частиц

  // Светящиеся частицы (глоу) (мобильные)
  mobileGlowParticleCount: 500, // Уменьшенное количество глоу-частиц для мобильных
  ...
  mobileParallaxIntensity: 0.3, // Уменьшенная интенсивность параллакса для мобильных
