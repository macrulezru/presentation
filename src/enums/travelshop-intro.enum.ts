  ...
  [DebugCategory.SAFE_ZONE]: [
    {
      ...
      setValue: (config, value) => {
        config.safeZoneMargins.horizontal = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.safeZoneMargins.vertical = value;
      },
    },
  ],
  [DebugCategory.AIRPORT_ELLIPSE]: [
    {
      ...
      setValue: (config, value) => {
        config.aircraft.airportEllipse.horizontalRadius = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.airportEllipse.verticalRadius = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.airportEllipse.centerXOffset = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.airportEllipse.centerYOffset = value;
      },
    },
  ],
  [DebugCategory.MOUSE_ELLIPSE]: [
    {
      ...
      setValue: (config, value) => {
        config.aircraft.mouseEllipse.horizontalRadius = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.mouseEllipse.verticalRadius = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.mouseEllipse.roundness = value;
      },
    },
  ],
  [DebugCategory.AIRCRAFT]: [
    {
      ...
      setValue: (config, value) => {
        config.aircraft.animationDuration = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.targetWidth = value;
      },
    },
  ],
  [DebugCategory.SMOOTHNESS]: [
    {
      ...
      setValue: (config, value) => {
        config.aircraft.followMouse.centerSmoothing = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.followMouse.ellipseSmoothing = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.followMouse.returnSpeed = value;
      },
    },
  ],
  [DebugCategory.AUTO_DIRECTION]: [
    {
      ...
      setValue: (config, value) => {
        config.aircraft.directionChange.sensitivity = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.directionChange.minVelocityThreshold = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.directionChange.minDistanceFactor = value;
      },
    },
  ],
  [DebugCategory.HYSTERESIS]: [
    {
      ...
      setValue: (config, value) => {
        config.aircraft.directionChange.hysteresis.threshold = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.directionChange.hysteresis.deadZone = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.directionChange.hysteresis.timeDelay = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.directionChange.hysteresis.angleBuffer = value;
      },
    },
  ],
  [DebugCategory.SMOOTHING]: [
    {
      ...
      setValue: (config, value) => {
        config.aircraft.directionChange.smoothing.factor = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.directionChange.smoothing.maxChangePerFrame = value;
      },
    },
  ],
  [DebugCategory.TILT]: [
    {
      ...
      setValue: (config, value) => {
        config.aircraft.tilt.maxAngle = value;
      },
    },
    {
      ...
      setValue: (config, value) => {
        config.aircraft.tilt.smoothFactor = value;
      },
    },
  ],
};
