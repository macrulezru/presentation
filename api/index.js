...
// Эндпоинт для получения одного случайного продукта
...
// Эндпоинт для получения нескольких случайных продуктов
...
app.listen(PORT, () => {
  ...
  console.log(`   GET  /api/product           - один случайный продукт`)
  console.log(`   GET  /api/product/:id       - продукт по ID`)
  console.log(`   GET  /api/products/random   - несколько случайных продуктов`)
